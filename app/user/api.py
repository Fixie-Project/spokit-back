...
from .serializers import (
    ...
    UserProfileStatsResponseSerializer,
...
class UserProfileSummaryAPIView(views.APIView):
    ...
    @extend_schema(
        responses=UserProfileStatsResponseSerializer,
        tags=["User"],
        summary="내 신청 상태 통계",
    )
...
class PublicUserProfileAPIView(views.APIView):
    ...
    @extend_schema(
        ...
        summary="사용자 공개 프로필",
        responses=PublicUserProfileResponseSerializer,
    )
...
class GoogleOAuthLoginAPIView(views.APIView):
    ...
    @extend_schema(
        ...
        responses=GoogleOAuthResponseSerializer,
    )
